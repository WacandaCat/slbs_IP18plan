    ...
    "sections": [
        section(T("周邊美食", "Food & Drink", "주변 맛집"), [
            poi(T("春水堂 朝富店", "Chun Shui Tang (Chaofu)", "춘수이탕 차오푸점"), T("台中市西屯區朝馬三街12號"),
                ...
                24.1666, 120.6362, tag=T("珍奶 / 茶館", "Bubble tea", "버블티"), hours=T("08:30–23:00"), origin=_o, photo=commons('Chun Shui Tang in West Kowloon Station 2018.jpg')),
            ...
            poi(T("鼎泰豐 台中大遠百店", "Din Tai Fung (Top City)", "딘타이펑 탑시티점"), T("台中市西屯區台灣大道三段251號B2"),
                ...
                24.1646, 120.6445, tag=T("小籠包", "Dumplings", "샤오롱바오"), hours=T("週一–五 11:00–21:30 · 週六日 10:30–21:30", "Mon–Fri 11:00–21:30 · Sat–Sun 10:30–21:30", "월–금 11:00–21:30 · 토·일 10:30–21:30"), origin=_o, photo=commons('Xiao Long Bao dumplings.jpg')),
